...
* **Hanrui Fang**: `config/hanrui_fang.yaml`, `config/hanrui_fang_subset.yaml`, `jobs/run_hanrui_qc.sbatch`, `jobs/run_hanrui_subset.sbatch`, `jobs/stage_hanrui_cellranger.sh`, `jobs/run_tests.sbatch`; see `docs/hanrui_qc_implementation.md`.
