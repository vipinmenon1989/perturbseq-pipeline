...
content = """# Figure-by-Figure Scientific Inventory
...
with open('Figure_Scientific_Inventory.md', 'w') as f:
    f.write(content)
print('Successfully wrote Figure_Scientific_Inventory.md, length:', len(content))
